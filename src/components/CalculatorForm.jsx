...
export default function CalculatorForm(props) {
  ...
  // Obsługa liczb z groszami (nie używamy Math.floor/round przy inpucie)
  const handleNumericChange = (val, setter, maxLimit = null) => {
    ...
    let num = Number(val);
    if (isNaN(num)) return;
    // Sprawdzamy limit (z zachowaniem groszy)
  ...
  return (
    <>
      ...
      {tryb === 'porownanie' ? (
        ...
        // --- TRYB WŁASNY (Zaktualizowany o suwaki i MAX) ---
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '15px', marginBottom: '20px' }}>
          ...
          <div style={{ ...cardStyle, background: '#f7fafc', borderColor: '#cbd5e0', marginBottom: 0 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
              ...
              <span style={{ fontSize: '11px', color: '#718096' }}>Max: {limitIKE.toLocaleString()} zł</span>
            </div>
            ...
            <input 
              ...
              step="0.01" 
              value={wplataIKE} 
              onChange={(e) => setWplataIKE(Number(e.target.value))}
              style={{ width: '100%', cursor: 'pointer', accentColor: '#3182ce', marginBottom: '15px' }} 
            />
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              />
              <button 
                onClick={() => setWplataIKE(limitIKE)} 
                style={{ background: '#3182ce', color: '#fff', border: 'none', borderRadius: '8px', padding: '0 15px', fontWeight: 'bold', cursor: 'pointer', fontSize: '12px' }}
              >
                MAX
              </button>
            </div>
          ...
          <div style={{ ...cardStyle, background: '#f7fafc', borderColor: '#cbd5e0', marginBottom: 0 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
              ...
              <span style={{ fontSize: '11px', color: '#718096' }}>Max: {limitIKZE.toLocaleString()} zł</span>
            </div>
            ...
            <input 
              ...
              step="0.01" 
              value={wplataIKZE} 
              onChange={(e) => setWplataIKZE(Number(e.target.value))}
              style={{ width: '100%', cursor: 'pointer', accentColor: '#38a169', marginBottom: '15px' }} 
            />
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              />
              <button 
                onClick={() => setWplataIKZE(limitIKZE)} 
                style={{ background: '#38a169', color: '#fff', border: 'none', borderRadius: '8px', padding: '0 15px', fontWeight: 'bold', cursor: 'pointer', fontSize: '12px' }}
              >
                MAX
              </button>
            </div>
